...
//    int inf; /**< Infinity Flag - not needed for Edwards representation */
    ...
    BN462::FP x; /**< x-coordinate of point */
#if CURVETYPE_BN462!=MONTGOMERY
    BN462::FP y; /**< y-coordinate of point. Not needed for Montgomery representation */
#endif
    BN462::FP z;/**< z-coordinate of point */
} ECP;
 ...
 */
extern void ECP_rhs(BN462::FP *r, BN462::FP *x);
 ...
 */
extern void ECP_map2point(ECP *Q, BN462::FP *x);

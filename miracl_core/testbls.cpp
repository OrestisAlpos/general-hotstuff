...
int bls_BN254(csprng *RNG, std::string &time_res)
{
    ...
    time_res.append("Miracl-BN254 SIGN: " + std::to_string(elapsedSign.count() / repetitions ) + "\n");
    time_res.append("Miracl-BN254 VERIFY: " + std::to_string(elapsedVerify.count() / repetitions ) + "\n");
    return 0;
}

#if CHUNK==32 || CHUNK==64

int bls_BLS12383(csprng *RNG, std::string &time_res)
{
    ...
    time_res.append("Miracl-BLS12383 SIGN: " + std::to_string(elapsedSign.count() / repetitions ) + "\n");
    time_res.append("Miracl-BLS12383 VERIFY: " + std::to_string(elapsedVerify.count() / repetitions ) + "\n");
    return 0;
}

int bls_BLS24479(csprng *RNG, std::string &time_res)
{
    ...
    time_res.append("Miracl-BLS24479 SIGN: " + std::to_string(elapsedSign.count() / repetitions ) + "\n");
    time_res.append("Miracl-BLS24479 VERIFY: " + std::to_string(elapsedVerify.count() / repetitions ) + "\n");
    return 0;
}

int bls_BLS48556(csprng *RNG,  std::string &time_res)
{
    ...
    time_res.append("Miracl-BLS48556 SIGN: " + std::to_string(elapsedSign.count() / repetitions ) + "\n");
    time_res.append("Miracl-BLS48556 VERIFY: " + std::to_string(elapsedVerify.count() / repetitions ) + "\n");
    return 0;
}
...
int main()
{
    ...
    bls_BN254(&RNG, time_res);

#if CHUNK!=16
    printf("\nTesting BLS signature for curve BLS12383\n");
    bls_BLS12383(&RNG, time_res);

    printf("\nTesting BLS signature for curve BLS24479\n");
    bls_BLS24479(&RNG, time_res);

    printf("\nTesting BLS signature for curve BLS48556\n");
    bls_BLS48556(&RNG, time_res);
#endif

    KILL_CSPRNG(&RNG);
    
    printf("%s \n", time_res.c_str());
    std::ofstream ofs("../test/microbench_pairings_miracl.txt");
	if (!(ofs << time_res)) return 1;
}

...
#define MODBITS_FP256BN MBITS_FP256BN
#define TBITS_FP256BN (MBITS_FP256BN%BASEBITS_B256_56)              /**< Number of active bits in top word */
#define TMASK_FP256BN (((chunk)1<<TBITS_FP256BN)-1)             /**< Mask for active bits in top word */
#define FEXCESS_FP256BN (((sign32)1<<MAXXES_FP256BN)-1)		    /**< 2^(BASEBITS*NLEN-MODBITS) - normalised BIG can be multiplied by less than this before reduction */

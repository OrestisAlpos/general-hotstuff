...
#ifndef FP_TWEEDLEDEE_H
#define FP_TWEEDLEDEE_H
...
#define MODBITS_TWEEDLEDEE MBITS_TWEEDLEDEE
#define TBITS_TWEEDLEDEE (MBITS_TWEEDLEDEE%BASEBITS_B256_56)              /**< Number of active bits in top word */
#define TMASK_TWEEDLEDEE (((chunk)1<<TBITS_TWEEDLEDEE)-1)             /**< Mask for active bits in top word */
#define FEXCESS_TWEEDLEDEE (((sign32)1<<MAXXES_TWEEDLEDEE)-1)		    /**< 2^(BASEBITS*NLEN-MODBITS) - normalised BIG can be multiplied by less than this before reduction */
#define OMASK_TWEEDLEDEE (-((chunk)(1)<<TBITS_TWEEDLEDEE))            /**<  for masking out overflow bits */

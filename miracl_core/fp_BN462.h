...
#define MODBITS_BN462 MBITS_BN462
#define TBITS_BN462 (MBITS_BN462%BASEBITS_B464_60)              /**< Number of active bits in top word */
#define TMASK_BN462 (((chunk)1<<TBITS_BN462)-1)             /**< Mask for active bits in top word */
#define FEXCESS_BN462 (((sign32)1<<MAXXES_BN462)-1)		    /**< 2^(BASEBITS*NLEN-MODBITS) - normalised BIG can be multiplied by less than this before reduction */

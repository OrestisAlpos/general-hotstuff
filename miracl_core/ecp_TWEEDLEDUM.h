...
#ifndef ECP_TWEEDLEDUM_H
#define ECP_TWEEDLEDUM_H

#include "fp_TWEEDLEDUM.h"
#include "config_curve_TWEEDLEDUM.h"
...
//    int inf; /**< Infinity Flag - not needed for Edwards representation */
    ...
    TWEEDLEDUM::FP x; /**< x-coordinate of point */
#if CURVETYPE_TWEEDLEDUM!=MONTGOMERY
    TWEEDLEDUM::FP y; /**< y-coordinate of point. Not needed for Montgomery representation */
#endif
    TWEEDLEDUM::FP z;/**< z-coordinate of point */
} ECP;
 ...
 */
extern void ECP_rhs(TWEEDLEDUM::FP *r, TWEEDLEDUM::FP *x);
 ...
 */
extern void ECP_map2point(ECP *Q, TWEEDLEDUM::FP *x);

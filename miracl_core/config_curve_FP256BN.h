...
#define CURVE_A_FP256BN 0
#define PAIRING_FRIENDLY_FP256BN BN_CURVE
#define CURVE_SECURITY_FP256BN 128
#define HTC_ISO_FP256BN 0
...
#define ATE_BITS_FP256BN 66
#define G2_TABLE_FP256BN 83

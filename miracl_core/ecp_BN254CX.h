...
//    int inf; /**< Infinity Flag - not needed for Edwards representation */
    ...
    BN254CX::FP x; /**< x-coordinate of point */
#if CURVETYPE_BN254CX!=MONTGOMERY
    BN254CX::FP y; /**< y-coordinate of point. Not needed for Montgomery representation */
#endif
    BN254CX::FP z;/**< z-coordinate of point */
} ECP;
 ...
 */
extern void ECP_rhs(BN254CX::FP *r, BN254CX::FP *x);
 ...
 */
extern void ECP_map2point(ECP *Q, BN254CX::FP *x);

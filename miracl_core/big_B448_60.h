...
#ifndef BIG_B448_60_H
#define BIG_B448_60_H
...
#define BIGBITS_B448_60 (8*MODBYTES_B448_60)
#define NLEN_B448_60 (1+((8*MODBYTES_B448_60-1)/BASEBITS_B448_60))
#define DNLEN_B448_60 2*NLEN_B448_60
#define BMASK_B448_60 (((chunk)1<<BASEBITS_B448_60)-1) /**< Mask = 2^BASEBITS-1 */
#define NEXCESS_B448_60 (1<<(CHUNK-BASEBITS_B448_60-1))           /**< 2^(CHUNK-BASEBITS-1) - digit cannot be multiplied by more than this before normalisation */

#define HBITS_B448_60 (BASEBITS_B448_60/2)      /**< Number of bits in number base divided by 2 */
#define HMASK_B448_60 (((chunk)1<<HBITS_B448_60)-1)    /**< Mask = 2^HBITS-1 */

//#define DEBUG_NORM

#ifdef DEBUG_NORM  /* Add an extra location to track chunk extension */
#define MPV_B448_60 NLEN_B448_60
#define MNV_B448_60 (NLEN_B448_60+1)
#define DMPV_B448_60 DNLEN_B448_60
#define DMNV_B448_60 (DNLEN_B448_60+1)
...
#ifdef DEBUG_NORM
typedef chunk BIG[NLEN_B448_60 + 2]; /**< Define type BIG as array of chunks */
typedef chunk DBIG[DNLEN_B448_60 + 2]; /**< Define type DBIG as array of chunks */
#else
typedef chunk BIG[NLEN_B448_60];     /**< Define type BIG as array of chunks */
typedef chunk DBIG[DNLEN_B448_60];   /**< Define type DBIG as array of chunks */
#endif

 ...
 */
extern void PAIR_precomp(BN254CX::FP4 T[], ECP2* GV);
 ...
 */
extern void PAIR_another(BN254CX::FP12 r[], ECP2* PV, ECP* QV);
 ...
 */
extern void PAIR_another_pc(BN254CX::FP12 r[], BN254CX::FP4 T[], ECP *QV);
 ...
 */
extern void PAIR_ate(BN254CX::FP12 *r, ECP2 *P, ECP *Q);
 ...
 */
extern void PAIR_double_ate(BN254CX::FP12 *r, ECP2 *P, ECP *Q, ECP2 *R, ECP *S);
 ...
 */
extern void PAIR_fexp(BN254CX::FP12 *x);
 ...
 */
extern void PAIR_GTpow(BN254CX::FP12 *x, B256_56::BIG b);
 ...
 */
extern int PAIR_G1member(BN254CX::ECP *P);
 ...
 */
extern int PAIR_G2member(BN254CX::ECP2 *P);
 ...
 */
extern int PAIR_GTcyclotomic(BN254CX::FP12 *x);
 ...
 */
extern int PAIR_GTmember(BN254CX::FP12 *x);
 ...
 */
extern void PAIR_initmp(BN254CX::FP12 r[]);
 ...
 */
extern void PAIR_miller(BN254CX::FP12 *res, BN254CX::FP12 r[]);

...
//    int inf; /**< Infinity Flag - not needed for Edwards representation */
    ...
    MDC::FP x; /**< x-coordinate of point */
#if CURVETYPE_MDC!=MONTGOMERY
    MDC::FP y; /**< y-coordinate of point. Not needed for Montgomery representation */
#endif
    MDC::FP z;/**< z-coordinate of point */
} ECP;
 ...
 */
extern void ECP_rhs(MDC::FP *r, MDC::FP *x);
 ...
 */
extern void ECP_map2point(ECP *Q, MDC::FP *x);

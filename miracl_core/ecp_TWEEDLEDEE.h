...
#ifndef ECP_TWEEDLEDEE_H
#define ECP_TWEEDLEDEE_H

#include "fp_TWEEDLEDEE.h"
#include "config_curve_TWEEDLEDEE.h"
...
//    int inf; /**< Infinity Flag - not needed for Edwards representation */
    ...
    TWEEDLEDEE::FP x; /**< x-coordinate of point */
#if CURVETYPE_TWEEDLEDEE!=MONTGOMERY
    TWEEDLEDEE::FP y; /**< y-coordinate of point. Not needed for Montgomery representation */
#endif
    TWEEDLEDEE::FP z;/**< z-coordinate of point */
} ECP;
 ...
 */
extern void ECP_rhs(TWEEDLEDEE::FP *r, TWEEDLEDEE::FP *x);
 ...
 */
extern void ECP_map2point(ECP *Q, TWEEDLEDEE::FP *x);

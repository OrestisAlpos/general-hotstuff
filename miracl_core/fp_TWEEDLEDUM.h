...
#ifndef FP_TWEEDLEDUM_H
#define FP_TWEEDLEDUM_H
...
#define MODBITS_TWEEDLEDUM MBITS_TWEEDLEDUM
#define TBITS_TWEEDLEDUM (MBITS_TWEEDLEDUM%BASEBITS_B256_56)              /**< Number of active bits in top word */
#define TMASK_TWEEDLEDUM (((chunk)1<<TBITS_TWEEDLEDUM)-1)             /**< Mask for active bits in top word */
#define FEXCESS_TWEEDLEDUM (((sign32)1<<MAXXES_TWEEDLEDUM)-1)		    /**< 2^(BASEBITS*NLEN-MODBITS) - normalised BIG can be multiplied by less than this before reduction */
#define OMASK_TWEEDLEDUM (-((chunk)(1)<<TBITS_TWEEDLEDUM))            /**<  for masking out overflow bits */

...
#define CURVE_A_NIST384 -3
#define PAIRING_FRIENDLY_NIST384 NOT_PF
#define CURVE_SECURITY_NIST384 192
#define HTC_ISO_NIST384 0

// Permit alternate compression method if 3 spare top bits in field representation
// Must be set manually
// #define ALLOW_ALT_COMPRESS_NIST384

#if PAIRING_FRIENDLY_NIST384 != NOT_PF

#define HTC_ISO_G2_NIST384 0

...
//    int inf; /**< Infinity Flag */
    BLS12461::FP2 x;   /**< x-coordinate of point */
    BLS12461::FP2 y;   /**< y-coordinate of point */
    BLS12461::FP2 z;   /**< z-coordinate of point */
} ECP2;
...
extern const B464_60::BIG CURVE_Bnx;   /**< Elliptic curve parameter */
 ...
 */
extern int ECP2_get(BLS12461::FP2 *x, BLS12461::FP2 *y, ECP2 *P);
 ...
 */
extern void ECP2_rhs(BLS12461::FP2 *r, BLS12461::FP2 *x);
 ...
 */
extern int ECP2_set(ECP2 *P, BLS12461::FP2 *x, BLS12461::FP2 *y);
 ...
 *
	...
	@return 1 if point exists, else 0
 */
extern int ECP2_setx(ECP2 *P, BLS12461::FP2 *x, int s);
 ...
 */
extern void ECP2_mul(ECP2 *P, B464_60::BIG b);
 ...
 */
extern void ECP2_frob(ECP2 *P, BLS12461::FP2 *f);
 ...
 */
extern void ECP2_mul4(ECP2 *P, ECP2 *Q, B464_60::BIG *b);
 ...
 */
extern void ECP2_map2point(ECP2 *Q, BLS12461::FP2 *x);
 ...
 */
extern void ECP2_hap2point(ECP2 *Q, B464_60::BIG  x);

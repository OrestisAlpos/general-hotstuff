...
#define MODBITS_BN254CX MBITS_BN254CX
#define TBITS_BN254CX (MBITS_BN254CX%BASEBITS_B256_56)              /**< Number of active bits in top word */
#define TMASK_BN254CX (((chunk)1<<TBITS_BN254CX)-1)             /**< Mask for active bits in top word */
#define FEXCESS_BN254CX (((sign32)1<<MAXXES_BN254CX)-1)		    /**< 2^(BASEBITS*NLEN-MODBITS) - normalised BIG can be multiplied by less than this before reduction */

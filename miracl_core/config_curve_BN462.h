...
#define CURVETYPE_BN462 WEIERSTRASS
#define CURVE_A_BN462 0
#define PAIRING_FRIENDLY_BN462 BN_CURVE
#define CURVE_SECURITY_BN462 128
#define HTC_ISO_BN462 0
...
#define USE_GS_GT_BN462 /**< Not patented, so probably safe to always use this */

#define POSITIVEX 0
#define NEGATIVEX 1

#define SEXTIC_TWIST_BN462 D_TYPE
#define SIGN_OF_X_BN462 POSITIVEX

#define ATE_BITS_BN462 118
#define G2_TABLE_BN462 125
...
namespace BN462_BIG = B464_60;
namespace BN462_FP = BN462;

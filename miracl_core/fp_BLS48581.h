...
#include "big_B584_60.h"
#include "config_field_BLS48581.h"

using namespace core;

#define MODBITS_BLS48581 MBITS_BLS48581
#define TBITS_BLS48581 (MBITS_BLS48581%BASEBITS_B584_60)              /**< Number of active bits in top word */
#define TMASK_BLS48581 (((chunk)1<<TBITS_BLS48581)-1)             /**< Mask for active bits in top word */
#define FEXCESS_BLS48581 (((sign32)1<<MAXXES_BLS48581)-1)		    /**< 2^(BASEBITS*NLEN-MODBITS) - normalised BIG can be multiplied by less than this before reduction */
...
typedef struct
{
    B584_60::BIG g;	/**< Big representation of field element */
    sign32 XES;	/**< Excess */
} FP;

/* Field Params - see rom.c */
extern const B584_60::BIG Modulus;	/**< Actual Modulus set in rom_field*.c */
extern const B584_60::BIG ROI;	    /**< Root of Unity  set in rom_field*.c */
extern const B584_60::BIG R2modp;	/**< Montgomery constant */
extern const chunk MConst;		/**< Constant associated with Modulus - for Montgomery = 1/p mod 2^BASEBITS */
extern const B584_60::BIG SQRTm3;      /**< Square root of -3 */
extern const B584_60::BIG CRu;    /**< Cube Root of Unity */
//extern const int BTset;			/**< Set Bit in Generalised Mersenne */
extern const B584_60::BIG Fra; /**< real part of Pairing-friendly curve Frobenius Constant */
extern const B584_60::BIG Frb; /**< imaginary part of Pairing-friendly curve Frobenius Constant */
extern const B584_60::BIG TWK; /**< Tweak for square roots, pre-calculated from field norm */
//#define FUSED_MODMUL
//#define DEBUG_REDUCE
 ...
 */
extern void FP_rcopy(FP *y, const B584_60::BIG x);
 ...
 */
extern void FP_mod(B584_60::BIG r, B584_60::DBIG d);

#ifdef FUSED_MODMUL
extern void FP_modmul(B584_60::BIG, B584_60::BIG, B584_60::BIG);
#endif
 ...
 */
extern void FP_pow(FP *x, FP *y, B584_60::BIG z);

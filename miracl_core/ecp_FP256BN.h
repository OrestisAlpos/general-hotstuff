...
//    int inf; /**< Infinity Flag - not needed for Edwards representation */
    ...
    FP256BN::FP x; /**< x-coordinate of point */
#if CURVETYPE_FP256BN!=MONTGOMERY
    FP256BN::FP y; /**< y-coordinate of point. Not needed for Montgomery representation */
#endif
    FP256BN::FP z;/**< z-coordinate of point */
} ECP;
 ...
 */
extern void ECP_rhs(FP256BN::FP *r, FP256BN::FP *x);
 ...
 */
extern void ECP_map2point(ECP *Q, FP256BN::FP *x);

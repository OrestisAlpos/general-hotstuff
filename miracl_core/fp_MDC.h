...
#define MODBITS_MDC MBITS_MDC
#define TBITS_MDC (MBITS_MDC%BASEBITS_B256_56)              /**< Number of active bits in top word */
#define TMASK_MDC (((chunk)1<<TBITS_MDC)-1)             /**< Mask for active bits in top word */
#define FEXCESS_MDC (((sign32)1<<MAXXES_MDC)-1)		    /**< 2^(BASEBITS*NLEN-MODBITS) - normalised BIG can be multiplied by less than this before reduction */
#define OMASK_MDC (-((chunk)(1)<<TBITS_MDC))            /**<  for masking out overflow bits */

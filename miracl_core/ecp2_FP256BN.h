...
//    int inf; /**< Infinity Flag */
    FP256BN::FP2 x;   /**< x-coordinate of point */
    FP256BN::FP2 y;   /**< y-coordinate of point */
    FP256BN::FP2 z;   /**< z-coordinate of point */
} ECP2;
 ...
 */
extern int ECP2_get(FP256BN::FP2 *x, FP256BN::FP2 *y, ECP2 *P);
 ...
 */
extern void ECP2_rhs(FP256BN::FP2 *r, FP256BN::FP2 *x);
 ...
 */
extern int ECP2_set(ECP2 *P, FP256BN::FP2 *x, FP256BN::FP2 *y);
 ...
 *
	...
	@return 1 if point exists, else 0
 */
extern int ECP2_setx(ECP2 *P, FP256BN::FP2 *x, int s);
 ...
 */
extern void ECP2_frob(ECP2 *P, FP256BN::FP2 *f);
 ...
 */
extern void ECP2_map2point(ECP2 *Q, FP256BN::FP2 *x);

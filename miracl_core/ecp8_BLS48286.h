...
//    int inf; /**< Infinity Flag */
    BLS48286::FP8 x;   /**< x-coordinate of point */
    BLS48286::FP8 y;   /**< y-coordinate of point */
    BLS48286::FP8 z;   /**< z-coordinate of point */
} ECP8;
...
extern const B288_60::BIG CURVE_Bnx;   /**< Elliptic curve parameter */
 ...
 */
extern int ECP8_get(BLS48286::FP8 *x, BLS48286::FP8 *y, ECP8 *P);
 ...
 */
extern void ECP8_rhs(BLS48286::FP8 *r, BLS48286::FP8 *x);
 ...
 */
extern int ECP8_set(ECP8 *P, BLS48286::FP8 *x, BLS48286::FP8 *y);
 ...
 *
	...
	@return 1 if point exists, else 0
 */
extern int ECP8_setx(ECP8 *P, BLS48286::FP8 *x,int s);
 ...
 */
extern void ECP8_mul(ECP8 *P, B288_60::BIG b);
 ...
 */
extern void ECP8_frob_constants(BLS48286::FP2 F[3]);
 ...
 */
extern void ECP8_frob(ECP8 *P, BLS48286::FP2 F[3], int n);
 ...
 */
extern void ECP8_mul16(ECP8 *P, ECP8 *Q, B288_60::BIG *b);
 ...
 */
extern void ECP8_map2point(ECP8 *Q, BLS48286::FP8 *x);
 ...
 */
extern void ECP8_hap2point(ECP8 *Q, B288_60::BIG  x);

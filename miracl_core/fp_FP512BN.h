...
#define MODBITS_FP512BN MBITS_FP512BN
#define TBITS_FP512BN (MBITS_FP512BN%BASEBITS_B512_60)              /**< Number of active bits in top word */
#define TMASK_FP512BN (((chunk)1<<TBITS_FP512BN)-1)             /**< Mask for active bits in top word */
#define FEXCESS_FP512BN (((sign32)1<<MAXXES_FP512BN)-1)		    /**< 2^(BASEBITS*NLEN-MODBITS) - normalised BIG can be multiplied by less than this before reduction */
...
typedef struct
{
    B512_60::BIG g;	/**< Big representation of field element */
    sign32 XES;	/**< Excess */
} FP;

/* Field Params - see rom.c */
extern const B512_60::BIG Modulus;	/**< Actual Modulus set in rom_field*.c */
extern const B512_60::BIG ROI;	    /**< Root of Unity  set in rom_field*.c */
extern const B512_60::BIG R2modp;	/**< Montgomery constant */
extern const chunk MConst;		/**< Constant associated with Modulus - for Montgomery = 1/p mod 2^BASEBITS */
extern const B512_60::BIG SQRTm3;      /**< Square root of -3 */
extern const B512_60::BIG CRu;    /**< Cube Root of Unity */
//extern const int BTset;			/**< Set Bit in Generalised Mersenne */
extern const B512_60::BIG Fra; /**< real part of Pairing-friendly curve Frobenius Constant */
extern const B512_60::BIG Frb; /**< imaginary part of Pairing-friendly curve Frobenius Constant */
extern const B512_60::BIG TWK; /**< Tweak for square roots, pre-calculated from field norm */
//#define FUSED_MODMUL
//#define DEBUG_REDUCE
 ...
 */
extern void FP_rcopy(FP *y, const B512_60::BIG x);
 ...
 */
extern void FP_mod(B512_60::BIG r, B512_60::DBIG d);

#ifdef FUSED_MODMUL
extern void FP_modmul(B512_60::BIG, B512_60::BIG, B512_60::BIG);
#endif
 ...
 */
extern void FP_pow(FP *x, FP *y, B512_60::BIG z);

...
::
    ...
    sudo cmake -DCMAKE_BUILD_TYPE=Release -DBUILD_SHARED=ON -DHOTSTUFF_PROTO_LOG=ON -DUSE_GENERALIZED_QUORUMS=OFF
    make

    #For the generalized, MSP-based or MBF-based HotStuff, run the following
    sudo cmake -DCMAKE_BUILD_TYPE=Release -DBUILD_SHARED=OFF -DHOTSTUFF_PROTO_LOG=ON -DUSE_GENERALIZED_QUORUMS=ON -DHOTSTUFF_ENABLE_BENCHMARK=ON -DGENERALIZED_QUORUMS_WITH_MSP=OFF
    make

    #To use BLS
    sudo cmake -DCMAKE_BUILD_TYPE=Release -DBUILD_SHARED=OFF -DHOTSTUFF_PROTO_LOG=ON -DUSE_GENERALIZED_QUORUMS=ON -DHOTSTUFF_ENABLE_BENCHMARK=ON -DUSE_BLS=ON

    #For microbenchmarks
    sudo cmake -DCMAKE_BUILD_TYPE=Debug -DBUILD_SHARED=OFF -DHOTSTUFF_PROTO_LOG=ON -DUSE_GENERALIZED_QUORUMS=ON -DHOTSTUFF_ENABLE_BENCHMARK=ON -DUSE_BLS=ON -DBUILD_TESTS=ON
